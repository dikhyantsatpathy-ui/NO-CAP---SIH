...
def _architecture_blueprint() -> str:
    ...
    return (
        ...
        "   - Screening Desk (MHA SIH26188): `/api/screen/document`, watchlist lookup, Verhoeff checksums, MRZ check digits.\n"
        ...
        "   - Deterministic identifier validation: Aadhaar (Verhoeff D-8 permutation check), Passport (ICAO 9303 TD3 MRZ check digits), Voter ID/PAN regex.\n"
